...
import GlassesIem from './GlassesIem'
...
class BaiTapGlasses extends Component {
    ...
    render () {
        ...
        let { id, name, url, desc } = this.props.spChiTiet;
        return (
            <div >
...
const mapStateToProps = (rootReducer) => {
    return {
        spChiTiet: rootReducer.BaiTapChonGlassesReducer,

    }
}

export default connect(mapStateToProps)(BaiTapGlasses);